              ...
              <div className="container-buttons-project-details">
                  ...
                  {showAbout && (
                    <div className="intro-bubble-proj-container">
                      ...
                      <p className="intro-bubble-proj nes-balloon from-left ">
                        Zero Waste is a web app that aims to reduce food waste
                        and build community! Check out my github if you&#39;re
                ...
                {showCollaborators && (
                  <div className="project-info-screen">
                    ...
                    <Link
                      ...
                      target="blank"
                    >
                      <div className="text">Shauni Vanderhorst</div>
                      <div className="spacer-20"></div>
                    </Link>
                    <p>
                      Shauni noticed that in order to contact the user you had
                      to manually copy or type the phone number. She added a
                      feature extension to fix this issue. Now when you click
                      the number it will automatically open in your phone.
                    </p>
                  </div>
                )}
                ...
                {showTechstack && (
                  <div className="techstack-section">
                    ...
                    {showNext && (
                      <div>
                        I chose Next because of the improved development
                    ...
                    {showStyling && (
                      <div>
                        I used this project to start getting more comfortable
                        with Tailwind, although I did also use Vanilla CSS.
                      </div>
                    )}

                    {showMulter && (
                      <div>
                        I used the middleware, Multer, to handle the image
                        upload because Multer is designed to handle
                        multipart/form-data in forms. I stored the image in a
                        local folder then stored the image_path to the database
                        in order to render uploaded images with the product
                        uploaded.
                      </div>
                    )}
                    ...
                    {showExpress && (
                      <div>
                        ...
                        framework. It also uses Javascript, is scalable, and has
                    ...
                    {showMySQL && (
                      <div>
                        {" "}
                        MySQL: I chose MySQL for the database because of
                        it&#39;s reliability and security as a database
                        management system. However, I am considering refactoring
                        and switching to MongoDB because of its geospatial query
                        capabilities.
                      </div>
                    )}
                  </div>
